...
$desc="";
    ...
    $insert=$db->prepare("insert into image3(image,description) values (:image,:description)");
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-6" style="margin:100px;text-align:left; border:1px solid #000; box-shadow:1px 2px 2px; width:600px; height:auto;">
            <h1>PAINTING IMAGE</h1>
                <form method="post" action="pain_admin.php" enctype="multipart/form-data">
